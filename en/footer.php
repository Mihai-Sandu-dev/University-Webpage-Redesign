...
<ul>
  <li class="<?php if ($currentPage == 'index.php') echo 'currentButton'; ?>">
    <a href="index.php"><img src="../images/home-svgrepo-com.svg" alt=""> Home </a>
  </li>
  <li class="<?php if ($currentPage == 'managementulCalitatii.php') echo 'currentButton'; ?>">
    <a href="managementulCalitatii.php"><img src="../images/pie-chart-svgrepo-com.svg" alt=""> Quality management </a>
  </li>
  <li class="<?php if ($currentPage == 'controlManagerial.php') echo 'currentButton'; ?>">
    <a href="controlManagerial.php"><img src="../images/slider-h-lg-svgrepo-com.svg" alt=""> Management control </a>
  </li>
...
<footer style="text-align: center;">
        ...
        <tr>
            <td width="20%"><p style="color: white"> © 2025 Information Technology and Data Communications Department </p></td>
        </tr>
        <tr>
            <td> <a href="https://www.ulbsibiu.ro/ro/" style="color: white"> „Lucian Blaga" University of Sibiu </a> </td>
        </tr>
        <tr>
            <td><p style="color: white"> <b> Adresa: </b> Address: 10 Victoriei Blvd. Sibiu, 550024, Romania </p></td>
        </tr>
        <tr>
            <td><p style="color: white"> <b> Telephone: </b> +40-(269) 21.77.79 </p></td>
        </tr>
        <tr>
