<!DOCTYPE HTML>
<html lang = "ro">
    <title> Feedback și evaluare </title>
...
<body style = "background-repeat: no repeat; background-size: 100% 100%">
    ...
    <!-- INFO -->
    <div class="semiTitle"><img src="../images/folder-svgrepo-com.svg" alt=" " class="semiTitleIcon"> Documente importante pentru <b> feedback </b> </div>
    <br>

        <details>
            <summary><img src="../images/trend-svgrepo-com.svg" alt=" " class="semiTitleIcon"> Evaluarea cadrelor didactice de către studenți </summary>
        <br>
            <ol>
    ...
    <!-- contact -->
    <div class="semiTitle"> Pentru mai multe detalii, puteţi contacta: </div>
<br>
    <div class="contactSection">
        <table>
            <tr><div class="info"> Telefon: +40-269-217.779 </div></tr>
            ...
            <tr><div class="info"> Adresa: Bd-ul. Victoriei, Nr.10, Sibiu, 550024, Romania </div></tr>
...
<br>
    ...
    <div class="semiTitle"> Sau accesaţi <b> canalele social media oficiale ULBS: </b> </div>
<br>
